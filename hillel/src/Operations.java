...
public class Operations {
    public static void main(String[] args) {
        ...
        boolean hasEnoghKnowledge = false;
        canAttend = paid() & hasEnoghKnowledge();
        ...
        boolean priorities = (paid()) | (advert()) & hasEnoghKnowledge();
    ...
    public static boolean hasEnoghKnowledge() {
        System.out.println("in hasEnoughKnowledge method");
        return false;
